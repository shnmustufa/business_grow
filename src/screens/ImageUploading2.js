...
const ImageUploading2 = ({route,navigation}) => {
  ...
  const uploadImage=async(image_uri) =>{
      ...
      let base_url="https://arzachel.org/business_grow/investor/profile_image.php?uemail="+myEmail;
 ...
 export default ImageUploading2;