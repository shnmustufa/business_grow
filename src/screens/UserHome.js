...
const UserHome = ({route,navigation})=>{
 ...
 const getUserDate = async () =>{
    ...
    try {
        const response = await fetch("https://arzachel.org/business_grow/user/getuserdetail.php?uemail="+myEmail);
...
useEffect( () => {
  getUserDate();
   ...
   return (
    ...
    <TouchableOpacity style={styles.column1} onPress={() => navigation.navigate("AddStartUpIdea",{myEmail : `${myEmail}`})}>
    <Image style={styles.lineimage}  source={require("../../assets/startup.png")} />
    <Text style={styles.linetext}>Add StartupIdea</Text>
    ...
    <View style={styles.item}>
    <TouchableOpacity style={styles.column1} onPress={() => navigation.navigate("AddFundRaising",{myEmail : `${myEmail}`})}>
    <Image style={styles.lineimage}  source={require("../../assets/fund.png")} />
    <Text style={styles.linetext}>Create FundRaising</Text>
    ...
    <Text style={styles.linetext}>My Idea</Text>
    ...
    <View style={styles.item}>
    <TouchableOpacity style={styles.column1} onPress={() => navigation.navigate("MyFundRequest",{myEmail : `${myEmail}`})} >
    <Image style={styles.lineimage}  source={require("../../assets/fundreq.png")} />
    <Text style={styles.linetext}>My Fund Request</Text>
